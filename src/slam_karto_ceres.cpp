...
SlamKartoCeres::SlamKartoCeres() : got_map_(false), laser_count_(0), transform_thread_(NULL), marker_count_(0)
{
  ...
  ss_ = node_.advertiseService("dynamic_map", &SlamKartoCeres::mapCallback, this);
  scan_filter_sub_ = new message_filters::Subscriber<sensor_msgs::LaserScan>(node_, "scan", 5);
  scan_filter_ = new tf::MessageFilter<sensor_msgs::LaserScan>(*scan_filter_sub_, tf_, odom_frame_, 5);
  scan_filter_->registerCallback(boost::bind(&SlamKartoCeres::laserCallback, this, _1));
  ...
  transform_thread_ = new boost::thread(boost::bind(&SlamKartoCeres::publishLoop, this, transform_publish_period));
...
void SlamKartoCeres::publishLoop(double transform_publish_period)
{
...
void SlamKartoCeres::publishTransform()
{
...
karto::LaserRangeFinder* SlamKartoCeres::getLaser(const sensor_msgs::LaserScan::ConstPtr& scan)
{
...
bool SlamKartoCeres::getOdomPose(karto::Pose2& karto_pose, const ros::Time& t)
{
...
void SlamKartoCeres::laserCallback(const sensor_msgs::LaserScan::ConstPtr& scan)
{
  laser_count_++;
...
bool SlamKartoCeres::addScan(karto::LaserRangeFinder* laser, const sensor_msgs::LaserScan::ConstPtr& scan,
...
bool SlamKartoCeres::mapCallback(nav_msgs::GetMap::Request& req, nav_msgs::GetMap::Response& res)
{
  boost::mutex::scoped_lock lock(map_mutex_);
